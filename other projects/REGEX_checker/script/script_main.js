document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        ...
        const patterns = {
            ...
            RFC: /^[A-Z]{4}([0-2][0-9]|3[0-1])([0][0-9]|[1][1-2])[0-9][0-9]([A-Z0-9]){3}$/, 
            CURP:/^[A-Z]{4}([0-2][0-9]|3[0-1])([0][0-9]|[1][1-2])\d{2}[HM](AS|BC|BS|CC|CL|CM|CS|CH|DF|DG|GT|GR|HG|JC|MC|MN|MS|NT|NL|OC|PL|QT|QR|SP|SL|SR|TC|TS|TL|VZ|YN|ZS|NE)[A-Z]{3}\d{2}$/,
            CP: /^[1-9]\d{4}$/, 
            BDay: /^(0?[1-9]|[12]\d|3[01])[-\/](0?[1-9]|1[0-2])[-\/](\d{2}|\d{4})$/, 
